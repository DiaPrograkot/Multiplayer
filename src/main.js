...
// Проверка наличия библиотеки trystero
if (!joinRoom || !selfId) {
  console.error('Библиотека trystero не импортирована или не инициализирована.');
} else {
  ...
  if (!room) {
    console.error('Не удалось инициализировать комнату.');
  } else {
    ...
    const showNotification = (message) => {
      ...
      if (notifications) {
        ...
        console.error('Элемент notifications не найден в DOM.');
      }
    };
